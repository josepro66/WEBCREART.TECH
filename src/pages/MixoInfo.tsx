...
const MixoInfo: React.FC = () => (
  <ProductInfoPage
    ...
    carouselText="Con una construcción metálica sólida y controles de alta calidad, el MIXO está diseñado para resistir el uso intensivo, proporcionando la confiabilidad que necesitas en tus sesiones más importantes. Totalmente personalizable en color de cuerpo, botones y caps."
    features={[
      { title: '4 Knobs Asignables', description: 'Cuatro perillas rotativas para control preciso de volúmenes, efectos y parámetros en tiempo real.' },
      { title: '4 Botones Arcade LED', description: 'Botones iluminados de alta respuesta para disparar clips, samples o funciones rápidas en tu flujo de trabajo.' },
      { title: '4 Faders', description: 'Faders de precisión para mezcla, automatizaciones y control de parámetros con respuesta suave y detallada.' },
      ...
      { title: 'Cuerpo Metálico Personalizable', description: 'Construcción sólida con colores de cuerpo, botones y caps a tu elección.' },
    ]}
    specs={[
      {
        title: 'Controles',
        items: [
          '4 knobs asignables',
          '4 botones arcade LED',
          '4 faders de precisión',
          'Cuerpo metálico personalizable',
        ],
      },
      {
        title: 'Conectividad',
