...
const FadoInfo: React.FC = () => (
  <ProductInfoPage
    ...
    carouselTitle="Control Preciso"
    carouselText="Cada fader está diseñado para una respuesta suave y precisa, permitiendo ajustes detallados en volumen, efectos, y otros parámetros. La construcción de alta calidad asegura durabilidad y fiabilidad en cada uso."
    features={[
      { title: '8 Faders de Precisión', description: 'Faders de alta precisión para un control suave y detallado de tus mezclas.' },
      { title: 'Cuerpo Metálico', description: 'Construcción robusta de metal con colores de cuerpo y faders personalizables a tu gusto.' },
      { title: 'Compatibilidad Total', description: 'Compatible con Ableton Live, Resolume, cualquier DAW u otro software que acepte MIDI.' },
      ...
      { title: 'Diseño Metálico', description: 'Cuerpo de aluminio cepillado para una máxima durabilidad y una estética profesional.' },
    ]}
    specs={[
      {
        title: 'Controles',
        items: [
          '8 faders de precisión',
          'Cuerpo metálico personalizable',
          'Colores de faders a elección',
        ],
      },
      {
        title: 'Conectividad',
    ...
    price="$650.000 COP"
    productId="fado"
    ctaGradient="from-purple-500 to-blue-500"
  />
);
