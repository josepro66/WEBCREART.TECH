...
const Beato16Configurator: React.FC<Beato16ConfiguratorProps> = ({ currentUser, onLogout }) => {
  ...
  const PALETTES: Palettes = {
    chasis: { 'Verde': { hex: '#7CBA40' }, 'Amarillo': { hex: '#F3E600' }, 'Azul': { hex: '#325EB7' }, 'Blanco': { hex: '#FFFFFF' }, 'Naranja': { hex: '#F47119' }, 'Morado': { hex: '#7B217E' }, 'Rojo': { hex: '#E52421' }, 'Rosa': { hex: '#FF007F' }, 'Gris': { hex: '#808080' }, },
